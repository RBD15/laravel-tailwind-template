    ...
    <div class="bg-gray-200 w-full min-h-screen flex items-center justify-center">
        <div class="w-full py-8">
            ...
            <div class="bg-white w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg shadow-2xl">
                ...
                <p class="text-center text-sm text-gray-600 mt-2">Don't have an account yet? <a href="#" class="text-primary hover:text-primary-dark hover:underline" title="Sign Up">Sign up here</a></p>
                ...
                <form class="my-8 text-sm">
                    ...
                    <div class="my-4 flex items-center justify-end space-x-4">
                        ...
                        <button class="bg-primary hover:bg-primary-dark rounded-lg px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 uppercase">Sign In</button>
                    </div>
                </form>
